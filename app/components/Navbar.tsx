...
function LangSwitcher() {
  ...
  return (
    <div style={{ display: "flex", alignItems: "center", gap: "0.1rem" }}>
      ...
      <span style={{ color: "#6b5a45", fontFamily: "'Jost', sans-serif", fontSize: "0.68rem", letterSpacing: "0.1em", textAlign: "center", fontWeight: 400, whiteSpace: "nowrap", lineHeight: 1, display: "flex", alignItems: "center" }}>
        {LANG_LABELS[lang]}
      </span>
